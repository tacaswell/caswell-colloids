...
# this module just copies the existing values into a new database with identical tables
# changed column types, defalt values, not NULL constraints in the generate_sql code
